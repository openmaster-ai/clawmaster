...
| 能力 | 状态 | 覆盖范围 |
|---|---|---|
| 能接管 | 已发布 | 向导、16 个供应商、6 种频道类型、Profile 管理 |
| 能观测 | 已发布 | ClawProbe 集成、费用 / Token / 健康度面板 |
| 能省钱 | 进行中 | PowerMem UI、seekdb 集成、降 Token 工作流 |
| 能应用 | 规划中 | 拍照答题、发票整理、错题本工具 |
